...
public partial class Mvc7DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Courses__3214EC07F2B66C08");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Students__3214EC07B26D357F");
            ...
            entity.HasOne(d => d.User).WithOne(p => p.Student)
                ...
                .HasConstraintName("FK_Studnets_Users");
        });

        modelBuilder.Entity<Teacher>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Teachers__3214EC07C3FFDC71");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC072C332205");
